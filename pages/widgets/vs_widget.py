...
class VSWidget(QWidget):
    def __init__(self):
        ...
        self.vs_label.setStyleSheet("color: orange;")
        ...
        self.bottom_line.setStyleSheet("background-color: white; color: white;")
        self.bottom_line.setFixedWidth(5)
        self.bottom_line.setFixedHeight(50)
        ...
        layout.setContentsMargins(20, 0, 20, 0)  # Add some horizontal padding